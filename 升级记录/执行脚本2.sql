...
--2、初始化赋值
  ...
  --获取企业Gid
  select Gid into v_EntGid from Ent where Lower(code) = lower('htx');--修改企业Code

  --定义模型代码
  v_ModelCode := 'HTX_Order1CK';
...
--4、定义工作流程名称 ，步骤等
  ...
  select v_EntGid, v_ModelGid, v_ModelCode, '原料出库单', 3, '禾田兴', '1.0', 0, 0 from dual;
  ...
  */
  ...
  insert into WF_Task_Define(EntGid, ModelGid, TaskDefGid, Code, Name, Note, OrderValue, IsStart, IsEnd, IsMCF)
  select v_EntGid, v_ModelGid, v_TaskGid_T1, v_ModelCode || '_T1', '填写申请单', '填写', 1, 1, 0, 0 from dual;
...
--5、定义工作流程步骤执行人
  ...
  insert into WF_Task_Define_Exec(EntGid, ModelGid, TaskDefGid, ExecGidEx, ExecCodeEx, ExecNameEx, OwnerValue)
  select v_EntGid, v_ModelGid, v_TaskGid_T2, Gid, Code, Name, 1 from v_Usr where EntGid = v_EntGid and lower(Code) = lower('admin_grp');
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '原料入库单', 3, '禾田兴', '1.0', 0, 0 from dual;
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '半成品出库单', 3, '禾田兴', '1.0', 0, 0 from dual;
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '半成品入库单', 3, '禾田兴', '1.0', 0, 0 from dual;
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '辅材出库单', 3, '禾田兴', '1.0', 0, 0 from dual;
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '辅材入库单', 3, '禾田兴', '1.0', 0, 0 from dual;
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '成品出库单', 3, '禾田兴', '1.0', 0, 0 from dual;
...
--4、定义工作流程名称 ，步骤等
  insert into WF_Model(EntGid, ModelGid, Code, Name, STAT, CLASSIFY, VERSION, AP1, AP2)
  select v_EntGid, v_ModelGid, v_ModelCode, '成品入库单', 3, '禾田兴', '1.0', 0, 0 from dual;
